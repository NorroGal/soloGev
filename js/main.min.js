  ...
  var o = {
    ...
    r = function () {
      ...
      a.owlCarousel({
        ...
        responsive: { 0: { items: 1 }, 980: { items: 1 }, 1100: { items: 2 } },
      }),
              ...
              $("body .probootstrap-animate.item-animate").each(function (o) {
                ...
                setTimeout(
                  function () {
                    ...
                    "fadeIn" === o
                      ? e.addClass("fadeIn probootstrap-animated")
                      : "fadeInLeft" === o
                      ? e.addClass("fadeInLeft probootstrap-animated")
                      : "fadeInRight" === o
                      ? e.addClass("fadeInRight probootstrap-animated")
                      : e.addClass("fadeInUp probootstrap-animated"),
